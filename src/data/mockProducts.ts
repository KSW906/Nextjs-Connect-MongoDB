...
export const mockProducts: Product[] = [
  ...
  },
  {
    ...
    careInstructions: '햇빛이 잘 드는 곳을 좋아하며 과습에 약합니다. 흙이 충분히 말랐을 때만 물을 주세요.',
    price: 14000,
    stock: 24,
    category: '다육식물',
  ...
  },
  {
    ...
    careInstructions: '밝은 간접광을 선호하고 겉흙이 마르면 물을 주세요. 잎에 먼지가 쌓이지 않도록 닦아주면 좋습니다.',
    price: 32000,
    stock: 10,
    category: '대형식물',
  ...
  },
  {
    ...
    careInstructions: '밝은 간접광에서 잘 자라며 겉흙이 마르면 물을 주세요. 줄기가 길어지면 가볍게 정리해도 좋습니다.',
    price: 15000,
    stock: 25,
    category: '공기정화식물',
  ...
  },
  {
    ...
    careInstructions: '반양지를 좋아하고 흙이 살짝 촉촉하게 유지되면 좋습니다. 물이 너무 오래 고이지 않게 해주세요.',
    price: 20000,
    stock: 19,
    category: '공기정화식물',
  ...
  },
  {
    ...
    careInstructions: '직사광을 어느 정도 견디며 흙이 충분히 마른 뒤 물을 주세요. 배수가 좋은 토양을 추천합니다.',
    price: 13000,
    stock: 28,
    category: '다육식물',
  ...
  },
  {
    ...
    careInstructions: '높은 습도를 선호하며 겉흙이 마르지 않게 관리해 주세요. 직사광선보다는 밝은 간접광이 좋습니다.',
    price: 17000,
    stock: 9,
    category: '중형식물',
  ...
  },
  {
    ...
    careInstructions: '과습에 주의하고 흙이 충분히 마르면 물을 주세요. 어두운 공간에서도 관리가 비교적 수월합니다.',
    price: 22000,
    stock: 17,
    category: '중형식물',
  ...
  },
  {
    ...
    detailedDescription: '은은한 줄무늬가 들어간 넓은 잎이 특징입니다. 침실이나 거실에 포인트 식물로 두기 좋습니다.',
    careInstructions:
  ...
  },
  {
    ...
    careInstructions: '배수홀 여부를 확인해 사용해주세요. 실내에서 사용할 경우 물받침과 함께 두면 관리가 편합니다.',
    price: 9000,
    stock: 40,
    category: '화분',
  ...
  },
  {
    ...
    careInstructions: '밝은 간접광을 좋아하며 흙이 마르면 물을 주세요. 줄기가 길어지면 잘라서 수형을 잡을 수 있습니다.',
    price: 19000,
    stock: 21,
    category: '중형식물',
  ...
  },
  {
    ...
    careInstructions: '밝은 간접광에서 관리하고 물은 자주 주지 않아도 됩니다. 흙이 거의 말랐을 때 물을 주세요.',
    price: 21000,
    stock: 14,
    category: '중형식물',
  ...
  },
  {
    ...
    careInstructions: '밝은 곳에서 키우되 강한 직사광은 피해주세요. 흙이 마른 뒤에 물을 주는 편이 좋습니다.',
    price: 16000,
    stock: 18,
    category: '중형식물',
  ...
  },
  {
    ...
    careInstructions: '햇빛이 잘 드는 곳에서 키우고 물은 흙이 충분히 마른 후 주세요. 겨울철 과습은 특히 주의합니다.',
    price: 15000,
    stock: 23,
    category: '다육식물',
  ...
  },
  {
    ...
    careInstructions: '햇빛이 잘 드는 곳에 두고 물은 아주 드물게 주세요. 통풍이 중요합니다.',
    price: 11000,
    stock: 27,
    category: '다육식물',
  ...
  },
  {
    ...
    careInstructions: '일조량이 풍부한 곳에서 키우고 흙이 바싹 마른 뒤 물을 주세요. 습한 환경은 피해주세요.',
    price: 12000,
    stock: 30,
    category: '다육식물',
  ...
  },
  {
    ...
    careInstructions: '밝은 간접광을 선호하며 흙이 마른 후 물을 주세요. 추위에는 약하니 실내 온도를 유지해주세요.',
    price: 27000,
    stock: 11,
    category: '공기정화식물',
  ...
  },
  {
    ...
    careInstructions: '햇빛이 잘 드는 밝은 곳을 좋아합니다. 흙이 마르면 물을 주고 통풍이 잘 되게 해주세요.',
    price: 24000,
    stock: 9,
    category: '중형식물',
  ...
  },
  {
    ...
    detailedDescription: '작고 촘촘한 잎이 부드럽게 늘어지는 아이비입니다. 작은 공간에 싱그러움을 더하기 좋습니다.',
    careInstructions: '밝은 간접광과 적당한 습도를 좋아합니다. 흙 표면이 마르면 물을 주세요.',
    price: 14500,
    stock: 20,
    category: '공기정화식물',
  ...
  },
  {
    ...
    detailedDescription: '하트 모양의 광택 있는 꽃이 인상적인 식물입니다. 화사한 포인트를 주고 싶을 때 잘 어울립니다.',
    careInstructions: '밝은 간접광에서 잘 자라고 흙을 약간 촉촉하게 유지해 주세요. 건조한 바람은 피하는 편이 좋습니다.',
    price: 23000,
    stock: 16,
    category: '중형식물',
  ...
  },
  {
    ...
    detailedDescription: '크림색 무늬가 섞인 넓은 잎이 특징인 식물입니다. 공간을 산뜻하고 부드럽게 보이게 해줍니다.',
    careInstructions: '직사광은 피하고 밝은 간접광에서 키워주세요. 흙 겉면이 마르면 물을 주는 정도가 적당합니다.',
    price: 21000,
    stock: 14,
    category: '공기정화식물',
  ...
  },
  {
    ...
    detailedDescription: '군더더기 없는 디자인의 화이트 세라믹 화분입니다. 실내를 깔끔하게 정리된 느낌으로 보여줍니다.',
    careInstructions: '실내 사용 시 물받침과 함께 사용하면 편합니다. 배수홀 유무를 확인하고 식물에 맞게 선택해주세요.',
    price: 11000,
    stock: 35,
    category: '화분',
  ...
  },
  {
    ...
    careInstructions: '햇빛이 잘 드는 곳에서 키우고 흙이 마르면 충분히 물을 주세요. 통풍이 중요합니다.',
    price: 45000,
    stock: 7,
    category: '대형식물',
