...
function HomeContent() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="relative h-48 overflow-hidden bg-gradient-to-r from-green-600 to-green-800 md:h-72">
        ...
        <div className="container relative mx-auto flex h-full items-center px-4">
          <div className="text-white">
            <h1 className="mb-4 text-4xl font-bold md:text-6xl">건강한 식물과 예쁜 화분</h1>
            <p className="mb-6 text-lg md:text-xl">집에 들이는 작은 정원, 지금 바로 시작해보세요.</p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8 lg:pl-20 xl:pl-64">
        ...
        {isLoading ? (
          ...
          <div className="py-12 text-center">
            ...
            <p className="text-sm text-gray-500">다른 검색어 또는 카테고리를 선택해보세요.</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-4">
